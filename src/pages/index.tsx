...
export default function Inventar(){
    ...
    return(
        <div className="flex w-full h-screen">
            ...
            <div className={"flex-1 transition-all flex flex-col md:p-10 pt-14 md:pt-14 md:pl-20 overflow-auto p-5 no-scrollbar "}>
            ...
            <div className={"border-l transition-all overflow-hidden  md:w-96 md:p-5 pt-14 md:pt-14 flex flex-col justify-center md:justify-start absolute top-0 bg-white h-screen right-0 md:static " + (open?"w-full p-5":"w-0 p-0")}>
